;(function (global, factory) {
  ...
  missingComponent = (function () {
    ...
    if (typeof global['google'] === 'object' && typeof global['google']['maps'] === 'object') {
      factoryArgs.push(global.google.maps)
    } else {
      return 'Google Maps Library'
    }
  })()
  ...
  function (gMapsApi) {
     ...
     * @param {Function} pareConstructor Parent class.
     */
    function inherits (childConstructor, pareConstructor) {
      childConstructor.superClass_ = pareConstructor.prototype
      childConstructor.prototype = Object.create(pareConstructor.prototype)
     ...
     * @constructor
     * @param {MarkerWithLabelOptions} [options] The optional parameters.
     */
    function MarkerWithLabel (options) {
      options = options || {}
      options.labelContent = options.labelContent || ''
      options.labelAnchor = options.labelAnchor || new gMapsApi.Point(0, 0)
      ...
      if (typeof options.labelVisible === 'undefined') {
        options.labelVisible = true
      }
      if (typeof options.raiseOnDrag === 'undefined') {
      ...
      if (typeof options.optimized === 'undefined') {
      ...
      options.optimized = false // Optimized rendering is not supported

      this.label = new MarkerLabel_(this, options.crossImage, options.handCursor) // Bind the label to the marker
